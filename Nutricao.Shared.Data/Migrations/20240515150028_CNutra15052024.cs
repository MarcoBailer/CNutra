...
{
    /// <inheritdoc />
    public partial class CNutra15052024 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RefeicaoPosicao_Usuarios_UsuarioId",
                        column: x => x.UsuarioId,
                        principalTable: "Usuarios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RefeicaoTurno_Usuarios_UsuarioId",
                        column: x => x.UsuarioId,
                        principalTable: "Usuarios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RefeicaoPosicao_UsuarioId",
                table: "RefeicaoPosicao",
                column: "UsuarioId");

            migrationBuilder.CreateIndex(
                name: "IX_RefeicaoTurno_UsuarioId",
                table: "RefeicaoTurno",
                column: "UsuarioId");
        }
